...
def copy_files(src_path, dest_path):
    ...
    if not files_copied:
        print("Error: No files ending with '_hw5A.cpp' or '_hw5B.cpp' or '_hw5C.cpp' found in the source path.")
        return
