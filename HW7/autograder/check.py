...
def copy_cpp_file(src_path):
    ...
    if cpp_files:
        ...
        # Check if the filename ends with "hw7.cpp" (case-insensitive)
        if filename.lower().endswith("hw7.cpp"):
            # Specify the fixed destination path for copying
            fixed_destination_path = "/autograder/source/HW7.cpp"
            ...
            print(f"No matching file ending with 'hw7.cpp' found. Found: {filename}")
    else:
